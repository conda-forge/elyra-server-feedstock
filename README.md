...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/elyra-server-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11195&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/elyra-server-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `elyra-server` can be installed with:

```
conda install elyra-server
```

It is possible to list all of the versions of `elyra-server` available on your platform with:
